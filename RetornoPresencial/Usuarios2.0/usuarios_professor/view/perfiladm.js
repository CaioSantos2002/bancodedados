...
const tableUsuario = document.querySelector("#bodyusuarios_professor");
const tablePessoa = document.querySelector("#bodyPessoas");
const urlPessoa = "http://localhost/usuarios_professor/src/controll/processa.pessoa.php?id=0";
const urlUsuario = "http://localhost/usuarios_professor/src/controll/processa.usuario.php?id=0";
...
const urlPerfil = "http://localhost/usuarios_professor/src/controll/processa.pessoa.php?id=" + urlId;
...
function carregausuarios_professor() {
    if (urlId !== undefined) {
        fetch(urlUsuario)
            .then(function (resp) {
                //Obtem a resposta da URL no formato JSON
...
function sair() {
    window.location.href = "http://localhost/usuarios_professor";
}
function atualizaPerfil(tipo) {
    let url = "http://localhost/usuarios_professor/src/controll/processa.usuario.php";
    let dados = "";
    msg.innerHTML = "";
    ...
    url = "http://localhost/usuarios_professor/src/controll/processa.pessoa.php";
    dados = "id=" + urlId;
...
function criaPessoa() {
    let url = "http://localhost/usuarios_professor/src/controll/processa.pessoa.php";
