...
class PessoaDAO
{ //Classe DAO (Data Access Object) com os métodos CRUD
	...
	function read($id)
	{ //Lista apenas a pessoa especificada pelo ID
		$pessoas = [];
	...
	{ //Atualiza os dados no Banco de dados, nas duas tabelas pessoas e telefones
		$resultado = [];
	...
	function del($id)
	{ //Método que exclui dados, pode apresentar erro de fluxo de dados também
